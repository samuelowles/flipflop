"""
Pulse Energy bill parser.

Pulse Energy (NZ) bills have a distinctive layout:
- "Pulse Energy" branding near the top
...
- Plan name (e.g. Energy Flexi, Energy Term, Energy Online)
...
class PulseParser(BaseParser):
    """Parser for Pulse Energy residential electricity bills."""

    RETAILER_NAME = "Pulse Energy"
    RETAILER_ID = "pulse"
    ...
    def parse(self, file_path: str) -> ParserResult:
        ...
        # --- Meter type ---
        # Pulse Energy canonical bills always carry enough signal to classify
...
# Register the parser
register_parser(PulseParser.RETAILER_ID, PulseParser)
